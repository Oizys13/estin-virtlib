...
const BookItems: NextPage<BookItemsType> = ({
  className = "",
  onGroupButtonClick,
}) => {
  ...
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-start py-0 pl-[3px] pr-0 box-border max-w-full text-left text-xl text-dimgray-600 font-inter ${className}`}
    >
