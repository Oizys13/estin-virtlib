...
const GroupComponent2: NextPage<GroupComponent2Type> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[198px] flex flex-col items-start justify-start pt-9 pb-0 pl-0 pr-[18px] box-border">
        <div className="self-stretch relative leading-[27px] z-[1] mq450:text-base mq450:leading-[21px]">
          Financial MGMT
        </div>
      </div>
      ...
      <div className="w-[179px] flex flex-col items-start justify-start pt-[34.5px] px-0 pb-0 box-border">
        <div
          className="self-stretch flex flex-row items-start justify-between gap-5 cursor-pointer z-[1]"
        ...
        >
          <img
            ...
            src="/heart.svg"
          />
          <button className="cursor-pointer border-tomato-100 border-[1px] border-solid py-1 pl-[13px] pr-3 bg-[transparent] w-[85px] rounded-8xs box-border flex flex-row items-start justify-start hover:bg-tomato-700 hover:border-tomato-500 hover:border-[1px] hover:border-solid hover:box-border">
