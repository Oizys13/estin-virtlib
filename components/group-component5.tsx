...
const GroupComponent5: NextPage<GroupComponent5Type> = ({ className = "" }) => {
  return (
    <div
      className={`flex-1 shadow-[0px_0px_30px_rgba(170,_170,_170,_0.16),_0px_10px_20px_rgba(194,_194,_194,_0.16)] rounded-[10px] bg-white flex flex-row items-end justify-start pt-12 px-6 pb-[120px] box-border gap-[75px] max-w-full z-[1] text-left text-xl text-tomato-200 font-inter mq800:flex-wrap ${className}`}
    >
