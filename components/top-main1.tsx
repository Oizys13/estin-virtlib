...
const TopMain1: NextPage<TopMain1Type> = ({
  ...
  return (
    ...
    >
      <div
        className="flex-1 self-stretch justify content-between rounded-tl-none rounded-tr-3xs rounded-b-none [background:linear-gradient(180deg,_#fff,_#f3f3f7_66.67%,_rgba(243,_243,_247,_0.88))] overflow-hidden flex flex-row items-center justify-center pt-[38px] pb-6 pl-[46px] pr-[45px] box-border gap-7 max-w-full"
        
      >
        <div className="flex-1 rounded-[40px] shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] rounded-21xl bg-white flex flex-row items-start py-0 pl-0 pr-[17px] box-border max-w-[541px] gap-5 z-[1]">
          ...
          <div className="w-[352px] flex flex-row items-center justify-center gap-[21px] max-w-full">
            <div className="rounded-tl-21xl  bg-[#F7F7FA] rounded-[40px]  rounded-tr-none rounded-br-none rounded-bl-21xl bg-whitesmoke-100 flex flex-row items-center justify-center pt-3 pb-[13px] pl-[37px] pr-[11px] gap-2.5 z-[1]">
              ...
              <div className="flex flex-col items-center justify-center pt-2 px-0 pb-0 box-border w-[17px] h-[17px]">
                <img
            ...
            <input
              className="w-full [border:none] [outline:none] bg-[transparent] h-9 flex-1 flex flex-col items-center justify-center pt-3 px-0 pb-0 box-border font-inter text-xl text-silver-100 min-w-[137px]"
              placeholder="Search"
              type="text"
            />
          </div>
          <div className="flex flex-col items-center justify-center pt-2 px-0 pb-0">
            <div className="h-[33px] flex flex-row items-center justify-center gap-[9.5px]">
              ...
              <div className="w-5 flex flex-col items-center justify-center pt-1.5 px-0 pb-0 box-border">
                <img
                  className="w-5 h-5 relative overflow-hidden shrink-0 z-[1]"
                  loading="lazy"
                  alt=""
        ...
        <div className="w-[170px] max-w-[170px] rounded-[40px] shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] rounded-11xl bg-white flex flex-row items-center justify-center pt-3 px-[25px] pb-[12.9px] box-border z-[1] text-center">
          <div className="h-[47px] w-[170px] relative shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] rounded-11xl bg-white hidden z-[1]" />
          <div className="flex flex-col items-center justify-center pt-0.5 pb-0 pl-0 pr-[7px]">
            <img
              className="w-5 h-5 relative overflow-hidden shrink-0 z-[1]"
              loading="lazy"
              alt=""
          ...
          <div className="flex flex-col items-center justify-center py-0 px-0 ml-[-7px]">
            <a className="ml-[-5px] [text-decoration:none] w-[91px] relative leading-[22.1px] text-[inherit] inline-block z-[1]">
              Lang
            </a>
          </div>
          <div className="flex flex-col items-center justify-center pt-[7px] px-0 pb-0 ml-[-7px]">
            <img
              className="w-[17px] h-[9px] relative rounded-12xs object-contain z-[1]"
              alt=""
              src="/search-icon.svg"
        ...
        <div className="w-[455px] max-w-[455px] flex flex-col items-center justify-center pt-px px-0 pb-0 box-border text-center text-mini font-digital-numbers mq1300:w-0">
          <div className="self-stretch rounded-[40px] shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] rounded-21xl bg-white flex flex-row items-start justify-between pt-3.5 pb-[13px] pl-[57px] pr-[52px] box-border max-w-full gap-5 z-[1] mq1300:hidden">
            ...
            <div className="w-[133px] flex flex-row items-center justify-center gap-[5px]">
              <img
            ...
            <div className="w-[149px] flex flex-row items-center justify-center gap-[5px]">
              <img
        ...
        <div className="w-[203px] rounded-[40px] max-w-[203px] shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] rounded-14xl bg-white flex flex-row items-center justify-center pt-[3px] px-[3px] pb-0.5 box-border z-[1]">
          <div className="h-[50px] w-[203px] relative shadow-[0px_0px_4px_rgba(0,_0,_0,_0.25)] rounded-14xl bg-white hidden" />
          <div className="flex flex-col items-center justify-center py-0 pl-0 pr-[18px]">
            <img
